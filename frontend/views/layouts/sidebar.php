        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Прейскурант цен', 'url' => ['/prices/prices'], 'icon' => 'users'],
                    ['label' => 'Наименование работ', 'url' => ['/services/services'], 'icon' => 'users'],
                    ['label' => 'Вариант прайса', 'url' => ['/tarifes/tarifes'], 'icon' => 'users'],
